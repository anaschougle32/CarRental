    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <Container className="relative z-10 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-8">
          ...
          <a href="tel:+919082888912" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-white text-white hover:bg-white/20 h-11 px-8 gap-2">
            <PhoneCall size={20} />
            Call Us Now
          </a>
        </div>
