  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col space-y-3">
      ...
      <a
        ...
        className="group relative bg-[#25D366] text-white p-3.5 rounded-full shadow-lg hover:bg-[#20bd5a] transition-all flex items-center justify-center"
        aria-label="Chat on WhatsApp"
        onMouseEnter={() => setIsExpanded(true)}
        onMouseLeave={() => setIsExpanded(false)}
      >
        <WhatsAppIcon className="w-6.5 h-6.5 fill-current flex-shrink-0" />
        <span className={cn(
